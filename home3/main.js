...
document.addEventListener('DOMContentLoaded', () => {
  ...
  searchInput.addEventListener('input', () => {
    ...
    if (!matches.length) { const div = document.createElement('div'); div.className = 'search-result-item'; div.style.color='rgba(245,240,232,0.3)'; div.style.cursor='default'; div.textContent='No results found'; searchResults.appendChild(div); }
  });
  ...
  document.querySelectorAll('form').forEach(form => {
    form.addEventListener('submit', (e) => {
      ...
      btn.textContent = '✓ Submitted! We\'ll call you soon.'; btn.style.background = '#166534'; btn.style.borderColor = '#166534';
      setTimeout(() => { btn.textContent = original; btn.style.background = ''; btn.style.borderColor = ''; form.reset(); }, 4000);
    });
  });
